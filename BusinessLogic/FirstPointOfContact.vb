...
#End Region
    ...
    Protected Friend Overridable Sub LoadDataRecord(ByRef Record As Object)
        ...
        With Record
            ...
            mDateOfFirstContact = Catchnull(.Item("DateOfFirstContact"), "")
            mDateOfFirstReferral = Catchnull(.Item("DateOfFirstReferral"), "")
            mDateFirstAdmitted = Catchnull(.Item("DateFirstAdmitted"), "")
