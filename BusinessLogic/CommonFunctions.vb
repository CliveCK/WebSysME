...
Public Class CommonFunctions
    ...
    Public ReadOnly Property Lookup(ByVal tableName As String, Optional ByVal valueColumn As String = "", Optional ByVal descriptionColumn As String = "", Optional ByVal orderColumn As String = "", Optional ByVal filterRows As String = "", Optional ByVal DISTINCT As Boolean = False) As System.Data.DataSet
