...
#Region "Retrieve Overloads"
    ...
    Public Overridable Function GetProjects(ByVal Project As Long) As DataSet
        ...
        If Project > 0 Then
            sql = "SELECT * FROM tblProjects WHERE Project = " & Project
        Else
            sql = "SELECT * FROM tblProjects WHERE Project = " & mProject
        End If
    ...
    Protected Overridable Function GetProjects(ByVal sql As String) As DataSet
    ...
    Public Function GetAllProjects(ByVal StatusID As Int16) As DataSet
        ...
        Dim sql As String = "SELECT * FROM tblProjects where IsActive = " & StatusID
