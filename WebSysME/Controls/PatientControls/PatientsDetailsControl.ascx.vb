        ...
        Try
            ...
            With objPatients
                ...
                If .Retrieve(PatientID) Then
                    ...
                    radDateofBirth.SelectedDate = .DOB
    ...
    Public Function Save() As Boolean
        ...
        Try
            ...
            With objPatients
                ...
                If cboReligion.SelectedIndex > -1 Then .ReligionID = cboReligion.SelectedValue
                If cboMedicalAidType.SelectedIndex > -1 Then .MedicalAidTypeID = cboMedicalAidType.SelectedValue
                If cboOrphanhood.SelectedIndex > -1 Then .OrphanhoodID = cboOrphanhood.SelectedValue
                If cboClosestHealthCenter.SelectedIndex > -1 Then .ClosestHealthCenterID = cboClosestHealthCenter.SelectedValue
                If cboSchool.SelectedIndex > -1 Then .SchoolID = cboSchool.SelectedValue
                .DOB = radDateofBirth.SelectedDate
