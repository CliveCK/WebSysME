...
#End Region
    ...
    Private Sub radMail_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles radMail.ItemCommand
        ...
        If e.CommandName = "RowClick" Then
            ...
            If TypeOf e.Item Is Telerik.Web.UI.GridDataItem Then
                ...
                Dim item1 As Telerik.Web.UI.GridDataItem = radMail.Items(index1)
                Dim markAsRead As Boolean = False

                Dim objMessageDb As New MessageHandler

                Dim Msg As Message = objMessageDb.GetMessageDetails(CookiesWrapper.thisUserID, Convert.ToInt32(IIf(IsNumeric(item1("messageid").Text), item1("messageid").Text, 0)), IIf(item1("senderid").Text = CookiesWrapper.thisUserID, False, True))
    ...
    Private Sub radMail_PreRender(sender As Object, e As EventArgs) Handles radMail.PreRender
        ...
        If Not IsNothing(radMail.DataSource) Then
            ...
            With radMail.MasterTableView
                ...
                .GetColumn("messageid").Visible = False
                .GetColumn("senderid").Visible = False
