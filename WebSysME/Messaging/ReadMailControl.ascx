...
<table cellpadding="4" cellspacing="2" style="width:100%">
    ...
    <tr>
        <td rowspan="2" style="text-align:left;vertical-align:top;padding-left:2%;border:1px solid darkblue" class="auto-style1">
            ...
            <td rowspan="2" style="text-align:center;vertical-align:top;width:20%;padding-left:2%;border:1px solid darkblue">
        ...
        <td style="padding-left:2%;align-content:center;border:1px solid darkblue">
            <asp:Panel runat="server" ID="pnlEditor" Visible="false" >
                <table style="width:90%">
                    <tr>
                        ...
                        <td align="left">
                        <asp:TextBox ID="txtFrom" runat="server" Width="50%" CssClass="form-control"></asp:TextBox></td>
                    </tr>
                     <tr>
                        <td style="width: 150px;">
                            <strong>Subject</strong></td>
                        <td align="left">
                        <asp:TextBox ID="txtSubject" runat="server" Width="50%" CssClass="form-control"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td  valign="top">
                        <strong>Message</strong></td>
                        <td align="left">
                        <telerik:RadEditor ID="radEMailMessage" runat="server" Width="90%" ContentAreaMode="Div" Skin="Simple">
                            <Content>
                            </Content>
                        </telerik:RadEditor>
